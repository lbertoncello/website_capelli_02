...
<nav class="navbar navbar-default">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-xs-4">
                <h1>Cadastro de Vestido</h1>
                <br />
                <br />
                <form action="./procCadastroVestido.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select name="tamanho" class="form-control" required>
                            ...
                            {
                            ?>
                            <option value="<?php echo $linha['id']; ?>"><?php echo $linha['dimensoes']; ?></option>
