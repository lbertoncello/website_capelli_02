...
<body>
    <div id="wrapper">
        <nav class="navbar">
            ...
            while($linha = mysqli_fetch_assoc($resultado)) {
                ...
                <div class="col-xs-4">
                    ...
                    <h4>Coleção</h4>
                    <p><?php echo $linha['colecaoNome']; ?></p>
                    <h4>Tamanho</h4>
                    <p><?php echo $linha['tamanhoNome']; ?></p>
                    <h4>Cor</h4>
                    <p><?php echo $linha['cor']; ?></p>
                    <h4>Preço</h4>
                    <p>R$ <?php echo $preco; ?></p>
                    <hr />
                    <a class="btn btn-default btn-primary center-block" href="./Carrinho.php?acao=add&id=<?php echo $linha['id']; ?>">Alugar</a>
                </div>
                <div class="col-xs-1"></div>
                <div class="col-xs-5">
                    <img src="Vestidos/<?php echo $linha['imagem']; ?>" class="pull-right" height="450" width="550" />
                </div>
            </div>
        ...
        <div class="esquerda">
            <div class="col-xs-5">
                <img src="Vestidos/<?php echo $linha['imagem']; ?>" height="450" width="550" />
            </div>
            <div class="col-xs-1"></div>
            <div class="col-xs-4">
                <h4>Modelo</h4>
