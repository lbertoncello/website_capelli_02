...
require 'Conexao.php';
$sql = "SELECT colecao.* , fornecedor.nome AS fornecedorNome
        FROM colecao INNER JOIN fornecedor WHERE colecao.idFornecedor = fornecedor.id";
            ...
            <div class="col-xs-12">
                <table class="table table-striped table-bordered table-hover table-responsive">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                              echo $linha['fornecedorNome']; ?>
                        </td>
                        <td>
                            <a href="./TelaAlterarColecao.php?id=<?php echo $linha['id']; ?>">Alterar</a>
                            ||
                            <a href="./procDeletarColecao.php?id=<?php echo $linha['id']; ?>">Deletar</a>
                        </td>
                    </tr>
                    <?php } ?>
                </table>
